...
// ------------- CoordManip ------------
// Constructeur
CoordManip::CoordManip(math::Point<> const& pt) : m_point(pt) {}
CoordManip::CoordManip(int x, int y)            : m_point({x, y}) {}

// Opérateurs
CoordManip  CoordManip::operator +  ()                         const { return CoordManip(+m_point); }
CoordManip  CoordManip::operator -  ()                         const { return CoordManip(-m_point); }
CoordManip  CoordManip::operator +  (math::Vecteur<> const& v) const { return CoordManip(m_point + v); }
CoordManip  CoordManip::operator -  (math::Vecteur<> const& v) const { return CoordManip(m_point - v); }
CoordManip& CoordManip::operator += (math::Vecteur<> const& v)       { m_point += v; return *this; }
CoordManip& CoordManip::operator -= (math::Vecteur<> const& v)       { m_point -= v; return *this; }
...
int const& CoordManip::y() const {
	return m_point[1];
}

// ------------- MouvManip -------------
// Constructeur
MouvManip::MouvManip(math::Vecteur<> const& v) : m_vecteur(v) {}
...
MouvManip  MouvManip::operator +  (math::Vecteur<> const& v) const { return MouvManip(m_vecteur + v); }
MouvManip  MouvManip::operator -  (math::Vecteur<> const& v) const { return MouvManip(m_vecteur + v); }
MouvManip& MouvManip::operator += (math::Vecteur<> const& v)       { m_vecteur += v; return *this; }
MouvManip& MouvManip::operator -= (math::Vecteur<> const& v)       { m_vecteur += v; return *this; }
